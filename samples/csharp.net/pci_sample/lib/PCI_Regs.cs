...
namespace Jungo.pci_lib
{
    ...
    {
        public DWORD dwAddrSpace;       /* Number of address space in which the
                                         * register resides */
        /* For PCI configuration registers, use WDC_AD_CFG_SPACE */
        public DWORD dwOffset;          /* Offset of the register in the
                                         * dwAddrSpace address space */
        public DWORD dwSize;            /* Register's size (in bytes) */
        public WDC_DIRECTION direction; /* Read/write access mode - see
                                         * WDC_DIRECTION options */
    ...
    public class PCI_Regs
    {
        private const uint WDC_AD_CFG_SPACE = 0xFF;
        public readonly WDC_REG[] gPCI_CfgRegs = new WDC_REG[]
        {
        ...
        public readonly WDC_REG[] gPCI_RT_Regs = {};
    };
}
