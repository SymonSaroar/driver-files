    ...
    union
    {
        ...
        {                    /* ITEM_INTERRUPT */
            ...
            u32 dwOptions;   /**< Interrupt options. For level sensitive
                                ...
                                */
            u32 hInterrupt;  /**< Returns the handle of the interrupt
                               installed */
            u32 dwReserved1;
            u64 pReserved2;
        } Int;
...
typedef struct
{
    u32 dwDomain; 	/**< Domain number. currently only applicable for Linux
                      systems. Zero by default */
    u32 dwBus; 		/**< Bus number */
    u32 dwSlot; 	/**< Slot number */
    u32 dwFunction; /**< Function number */
} WD_PCI_SLOT_32B;
